...
# Checking genes
enriched_genes <- genes_asd$genesofinterest
...
##### Plotting {style="background-color: #abf7b1; color: #777700; padding-top: 15px;   padding-right: 15px;   padding-bottom: 15px;   padding-left: 15px;"}
...
# Just to verify the names and that there are no repetitions
#View(time_adjcts[[1]][grepl("RELN|CACNA1H|RYR3", rownames(time_adjcts[[1]])),])

testing_genes <- c("RELN", "CACNA1H", "RYR3")

for (i in 1:length(time_metasubs)){
  for (k in testing_genes){
    cts <- time_adjcts[[i]][grepl(k, rownames(time_adjcts[[i]])),]
    ...
    box_plot <- grid.arrange(plot1, plot2, nrow = 1)
    
    direc <- paste0("images/expl_analysis/time_subsets/pre_batch/BatchVsDesVar/", intToUtf8(64+i), "_", time_metasubs[[i]]$GroupedAge[1])
    if(!file.exists(direc)){dir.create(direc)}
    
    ggsave(filename = paste0(direc, "/", k, ".png"), plot = box_plot, width = 15, height = 4, dpi = 300)
...
### Time - comparing all regions - Log2FoldChange and P-adj lists {style="background-color: #ffe800; color: #555500; padding-top: 15px;   padding-right: 15px;   padding-bottom: 15px;   padding-left: 15px"}
...
for (i in 1:length(time_metasubs)){
  ...
  for(j in 1:nlevels(met$GroupedRegion)){
    ...
    # Running DESeq2
    dds <- DESeqDataSetFromMatrix(countData = cts, colData = met, design = ~ pH + Group) # pegar daqui a matriz normalizada para usar no cemitool depois?
    dds <- DESeq(dds)
    res <- results(dds)
...
### Time - comparing only cortex - Log2FoldChange and P-adj lists {style="background-color: #ffe800; color: #555500; padding-top: 15px;   padding-right: 15px;   padding-bottom: 15px;   padding-left: 15px"}
...
### Space - comparing all ages - Log2FoldChange and P-adj lists {style="background-color: #ffe800; color: #555500; padding-top: 15px;   padding-right: 15px;   padding-bottom: 15px;   padding-left: 15px"}
...
### Space - comparing only early stages - Log2FoldChange and P-adj lists {style="background-color: #ffe800; color: #555500; padding-top: 15px;   padding-right: 15px;   padding-bottom: 15px;   padding-left: 15px"}
...
# Gene co-expression network analysis {style="background-color: #990000; color: #FFF685;  padding-top: 15px;   padding-right: 15px;   padding-bottom: 15px;   padding-left: 15px"}

### Time - Normalized counts matrix - adjusted for batch effect {style="background-color: #cc0000; color: #FFF685; padding-top: 15px;   padding-right: 15px;   padding-bottom: 15px;   padding-left: 15px"}
...
### Space - Normalized counts matrix - adjusted for batch effect {style="background-color: #cc0000; color: #FFF685; padding-top: 15px;   padding-right: 15px;   padding-bottom: 15px;   padding-left: 15px"}
...
### Time subsets {style="background-color: #cc0000; color: #FFF685; padding-top: 15px;   padding-right: 15px;   padding-bottom: 15px;   padding-left: 15px"}
...
### Time - Modules {style="background-color: #cc0000; color: #FFF685; padding-top: 15px;   padding-right: 15px;   padding-bottom: 15px;   padding-left: 15px"}
...
### Space subsets {style="background-color: #cc0000; color: #FFF685; padding-top: 15px;   padding-right: 15px;   padding-bottom: 15px;   padding-left: 15px"}
...
### Space - Modules {style="background-color: #cc0000; color: #FFF685; padding-top: 15px;   padding-right: 15px;   padding-bottom: 15px;   padding-left: 15px"}
